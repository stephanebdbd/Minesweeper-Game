...
Pour que les test fonctionnent, il faut également que votre fonction "main()" renvoie 1 en cas de victoire, 0 en cas de défaite.
...
def test_echec_input(monkeypatch):
    """
    Séries d'inputs incorrects suivis
    """
    random.seed(74)
    args = ['', '12', '12', '5']
    with mock.patch.object(sys, 'argv', args):
